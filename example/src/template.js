...
export const sourcecodeB = `<vm-button :plain="true" disabled>默认按钮</vm-button>
...
export const sourcecodeE = `<vm-button-group>
...
export const sourcecodeF = `<vm-button type="primary" :loading="true">加载中</vm-button>
...
export const sourcecodeG = `<vm-button type="primary" size="large">大型按钮</vm-button>
